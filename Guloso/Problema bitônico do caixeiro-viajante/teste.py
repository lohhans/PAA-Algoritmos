...
print("Problema bitonico euclidiano do caixeiro-viajante:")
matriz.mostrarMatriz(matriz) #Print da matriz
print(" ")

# Registra o momento antes da execucao do algoritmo
t0 = datetime.now()

# Roda o algoritmo 10 vezes
for k in range(10):
    resp = caixeiroViajante(matriz) #Realiza o caminho bitonico

# Registra o momento apos a execucao do algoritmo
t1 = datetime.now()
...
print("Media de tempo do Algoritmo Guloso executado 10 vezes: " + str(tempo) + " ms")
